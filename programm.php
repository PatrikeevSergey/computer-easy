...
?>
    ...
    <div id="nav">
    <p id="nav-circuit"><a href="index.php">Главная страница</a> \<a href="for beginners.php"> Компьютер для начинающих</a> \ <span>Какие бывают программы?</span></p>
    </div>
  <p class="tit"> </p>
      
  <p id="warning" class="tit"></p>
  <p class="tit"></p>
   </ul>
   </div>
